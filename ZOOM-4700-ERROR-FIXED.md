...
Configure environment variables in `.env` (load from environment):
```env
BOT_TOKEN=<your-bot-token>
ZOOM_CLIENT_ID=<your-zoom-client-id>
ZOOM_CLIENT_SECRET=<your-zoom-client-secret>
ZOOM_REDIRECT_URI=<your-redirect-uri>
```

**Note:** Load these values from environment variables for security. Never commit actual credentials to version control.
